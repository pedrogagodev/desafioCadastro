...
public class AgeAndWeightSearchStrategy implements  PetSearchStrategy {
    private final WeightSearchStrategy weightSearchStrategy;

    public AgeAndWeightSearchStrategy(WeightSearchStrategy weightSearchStrategy) {
        this.weightSearchStrategy = weightSearchStrategy;
    }
    ...
    public List<Path> search(PetType petType, PetCollector collector, FileRepository fileRepository) {
        List<Path> petsByWeight = weightSearchStrategy.search(petType, collector, fileRepository);
