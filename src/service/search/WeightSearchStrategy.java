...
public class WeightSearchStrategy implements PetSearchStrategy {
    @Override
    ...
    public List<Path> search(PetType petType, PetCollector collector, FileRepository fileRepository) {
        ...
        Pattern agePattern = Pattern.compile("\\b" + petWeight + "+kg\\b", Pattern.CASE_INSENSITIVE);        for (Path s : allPets) {
